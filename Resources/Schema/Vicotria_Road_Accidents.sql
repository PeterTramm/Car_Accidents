...
CREATE TABLE Atmospheric (
  ...
  CONSTRAINT PK_Atmospheric PRIMARY KEY (Accident_No, Atmosph_Cond_Seq),
	CONSTRAINT FK_Atmospheric_Accident_No FOREIGN KEY (Accident_No) REFERENCES AccidentInfo(Accident_No),
...
CREATE TABLE RoadSurfaceType (
  ...
  Road_Surface_Type_Desc varchar(200) NOT NULL
);
...
CREATE TABLE TrafficControl (
  ...
  Traffic_Control_Desc varchar(200) NOT NULL 
);
...
CREATE TABLE Vehicle (
  ...
  CONSTRAINT PK_Vehicle PRIMARY KEY (Accident_No, Vehicle_ID),
	CONSTRAINT FK_Vehicle_Accident_no FOREIGN KEY (Accident_No) REFERENCES AccidentInfo(Accident_No),
...
CREATE TABLE Person (
  ...
  CONSTRAINT PK_Person PRIMARY KEY (Accident_No, Person_ID, Vehicle_ID),
	CONSTRAINT FK_Person_Accident_No FOREIGN KEY (Accident_No) REFERENCES AccidentInfo(Accident_No),
...
CREATE TABLE AccidentEvent (
  ...
  CONSTRAINT PK_AccidentEvent PRIMARY KEY (Accident_No, Event_Seq_No),
	CONSTRAINT FK_Accident_Event FOREIGN KEY (Accident_No) REFERENCES AccidentInfo(Accident_No),
